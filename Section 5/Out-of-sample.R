...
#load the data
load("C:/Users/Martin/Desktop/CoVaR/R/Data/Crypto/Usable/vec/BTC.RData")
load("C:/Users/Martin/Desktop/CoVaR/R/Data/Crypto/Usable/vec/LTC.RData")
load("C:/Users/Martin/Desktop/CoVaR/R/Data/Crypto/Usable/vec/XMR.RData")
load("C:/Users/Martin/Desktop/CoVaR/R/Data/Crypto/Usable/vec/XRP.RData")
...
#1. Estimate GJR-GARCH(1,1) model with constant mean and skew-t-innovations using window.size observations
...
getCoVaR_OOS = function(CurrSample, type, copula, n.ahead, alpha, beta){
  if(!is.element(type, c("VaR", "Bivariate", "Multi", "Vulnerability"))){
  ...
  if(type == "Bivariate"){
    if(copula == "t"){
      estCop = try(fitCopula(copula = tCopula(), data = cbind(v, u1), 
                             estimate.variance = F, method = "ml")@estimate)
...
get_FC = function(data, type, copula, window.length = 500, n.ahead = 5, alpha = 0.05, beta = 0.05){
  #initializing
  res = c()
  data = as.matrix(data)
  nobs = nrow(data)
...
#out-of-sample VaR
VaRLTC = get_FC(data = rLTC, type = "VaR", window.length = 500, n.ahead = 5,
                copula = NULL, alpha = 0.05, beta = NULL)
VaRXMR = get_FC(data = rXMR, type = "VaR", window.length = 500, n.ahead = 5,
                copula = NULL, alpha = 0.05, beta = NULL)
VaRXRP = get_FC(data = rXRP, type = "VaR", window.length = 500, n.ahead = 5,
                copula = NULL, alpha = 0.05, beta = NULL)
VaRSys = get_FC(data = rSys, type = "VaR", window.length = 500, n.ahead = 5,
                copula = NULL, alpha = 0.05, beta = NULL)

#out-of-sample bivariate CoVaR and SCoVaR
t_CoVaR_LTC = get_FC(data = cbind(rBTC, rLTC), type = "Bivariate", window.length = 500, n.ahead = 5,
                     copula = "t", alpha = 0.05, beta = 0.05)
t_CoVaR_XMR = get_FC(data = cbind(rBTC, rXMR), type = "Bivariate", window.length = 500, n.ahead = 5,
                     copula = "t", alpha = 0.05, beta = 0.05)
t_CoVaR_XRP = get_FC(data = cbind(rBTC, rXRP), type = "Bivariate", window.length = 500, n.ahead = 5,
                     copula = "t", alpha = 0.05, beta = 0.05)
t_SCoVaR = get_FC(data = cbind(rBTC, rSys), type = "Bivariate", window.length = 500, n.ahead = 5,
                  copula = "t", alpha = 0.05, beta = 0.05)

Clayton_CoVaR_LTC = get_FC(data = cbind(rBTC, rLTC), type = "Bivariate", window.length = 500, n.ahead = 5,
                           copula = "clayton", alpha = 0.05, beta = 0.05)
Clayton_CoVaR_XMR = get_FC(data = cbind(rBTC, rXMR), type = "Bivariate", window.length = 500, n.ahead = 5,
                           copula = "clayton", alpha = 0.05, beta = 0.05)
Clayton_CoVaR_XRP = get_FC(data = cbind(rBTC, rXRP), type = "Bivariate", window.length = 500, n.ahead = 5,
                           copula = "clayton", alpha = 0.05, beta = 0.05)
Clayton_SCoVaR = get_FC(data = cbind(rBTC, rSys), type = "Bivariate", window.length = 500, n.ahead = 5,
                        copula = "clayton", alpha = 0.05, beta = 0.05)

#out-of-sample MCoVaR
t_MCoVaR = get_FC(data = cbind(rBTC, rLTC, rXMR, rXRP), type = "Multi", window.length = 500, 
                  n.ahead = 5, copula = "t", alpha = 0.05, beta = 0.05)
Clayton_MCoVaR = get_FC(data = cbind(rBTC, rLTC, rXMR, rXRP), type = "Multi", window.length = 500, 
                        n.ahead = 5, copula = "clayton", alpha = 0.05, beta = 0.05)
Gumbel_MCoVaR = get_FC(data = cbind(rBTC, rLTC, rXMR, rXRP), type = "Multi", window.length = 500, 
                        n.ahead = 5, copula = "gumbel", alpha = 0.05, beta = 0.05)
...
#Bivariate CoVaR and SCoVaR evaluation
...
rbind(c(t_CoVaR_LTC_eval$rate, Clayton_CoVaR_LTC_eval$rate),
      c(t_CoVaR_XMR_eval$rate, Clayton_CoVaR_XMR_eval$rate),
      c(t_CoVaR_XRP_eval$rate, Clayton_CoVaR_XRP_eval$rate),
      c(t_SCoVaR_eval$rate, Clayton_SCoVaR_eval$rate),
      c(t_MCoVaR_eval$rate, Clayton_MCoVaR_eval$rate),
      c(t_VCoVaR_eval$rate, Clayton_VCoVaR_eval$rate))
