...
as.numeric(2*(length(coef(fitrBTC)) + length(coef(fitrLTC)) + length(coef(fitrXMR)) + length(coef(fitrXRP)) + length(coef(TIfitMulti1)))
           -2*(logLik(TIfitMulti1) + fitrBTC@fit$LLH + fitrLTC@fit$LLH + fitrXMR@fit$LLH + fitrXRP@fit$LLH)) #AIC
