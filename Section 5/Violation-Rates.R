...
#MCoVaR
TIfitMulti1 = fitCopula(copula = normalCopula(dim = 4, dispstr = "un"), estimate.variance = F,
                        data = cbind(v, u1, u2, u3))
copMulti = normalCopula(param = TIfitMulti1@estimate, dim = 4, dispstr = "un")
...
###################################### t-COPULA COVARS ###########################################
#BTC-LTC
TIcop1 = fitCopula(copula = tCopula(), data = cbind(v, u1), estimate.variance = F)
...
#BTC-XMR
TIcop2 = fitCopula(copula = tCopula(), data = cbind(v, u2), estimate.variance = F)
...
#BTC-XRP
TIcop3 = fitCopula(copula = tCopula(), data = cbind(v, u3), estimate.variance = F)
...
#SCoVaR
TIcop4 = fitCopula(copula = tCopula(), data = cbind(v, u4), estimate.variance = F)
...
#MCoVaR
TIfitMulti1 = fitCopula(copula = tCopula(dim = 4, dispstr = "un"), estimate.variance = F,
                        data = cbind(v, u1, u2, u3))
copMulti = tCopula(param = TIfitMulti1@estimate[-7], df = round(TIfitMulti1@estimate[7]), dim = 4, dispstr = "un")
...
#BTC-LTC
TIcop1 = fitCopula(copula = claytonCopula(), data = cbind(v, u1), estimate.variance = F)
...
#BTC-XMR
TIcop2 = fitCopula(copula = claytonCopula(), data = cbind(v, u2), estimate.variance = F)
...
#SCoVaR
TIcop4 = fitCopula(copula = claytonCopula(), data = cbind(v, u4), estimate.variance = F)
...
#MCoVaR
TIfitMulti1 = fitCopula(copula = claytonCopula(dim = 4), estimate.variance = F,
                        data = cbind(v, u1, u2, u3))
copMulti = claytonCopula(param = TIfitMulti1@estimate, dim = 4)
...
#BTC-LTC
TIcop1 = fitCopula(copula = gumbelCopula(), data = cbind(v, u1), estimate.variance = F)
...
#BTC-XMR
TIcop2 = fitCopula(copula = gumbelCopula(), data = cbind(v, u2), estimate.variance = F)
...
#BTC-XRP
TIcop3 = fitCopula(copula = gumbelCopula(), data = cbind(v, u3), estimate.variance = F)
...
#SCoVaR
TIcop4 = fitCopula(copula = gumbelCopula(), data = cbind(v, u4), estimate.variance = F)
...
#MCoVaR
TIfitMulti1 = fitCopula(copula = gumbelCopula(dim = 4), estimate.variance = F,
                        data = cbind(v, u1, u2, u3))
copMulti = gumbelCopula(param = TIfitMulti1@estimate, dim = 4)
...
BivDCCfit1 = cgarchfit(spec = BivDCCspec1, data = cbind(rBTC, rLTC))
...
BivDCCspec2 = cgarchspec(uspec = multispec(list(specrBTC, specrXMR)), dccOrder = c(1,1),
                         distribution.model = list(copula = "mvt", method = "ML", time.varying = TRUE, 
                                                   transformation = "parametric"))
BivDCCfit2 = cgarchfit(spec = BivDCCspec2, data = cbind(rBTC, rXMR))
...
BivDCCspec3 = cgarchspec(uspec = multispec(list(specrBTC, specrXRP)), dccOrder = c(1,1),
                         distribution.model = list(copula = "mvt", method = "ML", time.varying = TRUE, 
                                                   transformation = "parametric"))
BivDCCfit3 = cgarchfit(spec = BivDCCspec3, data = cbind(rBTC, rXRP))
...
BivDCCspec4 = cgarchspec(uspec = multispec(list(specrBTC, specrSys)), dccOrder = c(1,1),
                         distribution.model = list(copula = "mvt", method = "ML", time.varying = TRUE, 
                                                   transformation = "parametric"))
BivDCCfit4 = cgarchfit(spec = BivDCCspec4, data = cbind(rBTC, rSys))
...
DCCspec1 = cgarchspec(uspec = multispec(list(specrBTC, specrLTC, specrXMR, specrXRP)), dccOrder = c(1,1),
                      distribution.model = list(copula = "mvt", method = "ML", time.varying = TRUE, 
                                                transformation = "parametric"))
DCCfit1 = cgarchfit(spec = DCCspec1, data = cbind(rBTC, rLTC, rXMR, rXRP))
...
system.time(DCC_VCoVaR <- getDCCVCoVaR(DCCfit1, alpha = 0.05, beta = 0.05))
